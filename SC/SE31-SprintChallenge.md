...
- What, in your opinion, is an important part of code reviews? That is, what is
  something you pay attention to when you review code, and that you appreciate when others do the same for your code?

It is very helpful to have a second set of eyes to help you see where code may not be as comprehensible as the original 
writer thinks. Someone reviewing code does not have the same familiarity with it that the original author of the code does,
so they are better able to see what comments and changes may make the code easier to understand. Being able to quickly 
understand code is critical for efficiently maintaining codebases. In addition, code reviewers may see more efficient ways
to achieve certain outcomes. This makes the code better, but also provides opportunities to learn and improve.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  Containers help by standardizing software. They specify exactly what version of all packages and dependencies is in the 
  container and ignores whatever may be installed locally. This allows whatever is in the container to be run reproducibly 
  because it is always in the exact same environment within the container.
